...
const CardsFTZ: React.FC<Props> = ({FrtGrtsCard,Parcela,src,TituloCard, PrecoAnterior, PrecoAtual,href }) => {
        ...
        return (
            <CardFTZdiv id="cardFTZ" className="cardFTZ">
                ...
                <CorpoCard id="corpoCard" className="corpoCard">
                    ...
                    <PrecoAtualdiv  id="precoAnterior" className="precoAtual">{PrecoAtual}</PrecoAtualdiv >
                </CorpoCard>
