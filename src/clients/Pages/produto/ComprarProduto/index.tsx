                        ...
                        <DescAnunPrd id="descAnunPrd" className="descAnunPrd">
                            <ConteudoDescAnunPrd id="conteudoDescAnunPrd" className="conteudoDescAnunPrd">
                                ...
                                <div id="tmnhQtd" className="tmnhQtd">
                                    <p>Quantidade</p>
                                    <input type="number" placeholder="Nº" min='1' max={categoria.calcado.quantidade} />
                                </div>
                    ...
                    <GridVisuPrd id="gridVisuPrd" className="gridVisuPrd">
                        ...
                        <DescAnunPrd id="descAnunPrd" className="descAnunPrd">
                            <ConteudoDescAnunPrd id="conteudoDescAnunPrd" className="conteudoDescAnunPrd">
                                ...
                                <div id="tmnhQtd" className="tmnhQtd">
                                    <p>Quantidade</p>
                                    <input type="number" placeholder="Nº" min='1' max={categoria.equipamento.quantidade} />
                                </div>
                                <div id="btnLinkPrd" className="btnLinkPrd">
                                    <a href="/carrinhoDeCompra"><input type="button" value="Comprar" /></a>
                                    <a href={''}>Calcular frete</a>
                    ...
                    <GridVisuPrd id="gridVisuPrd" className="gridVisuPrd">
                        ...
                        <DescAnunPrd id="descAnunPrd" className="descAnunPrd">
                            <ConteudoDescAnunPrd id="conteudoDescAnunPrd" className="conteudoDescAnunPrd">
                                ...
                                <div id="tmnhQtd" className="tmnhQtd">
                                    <p>Quantidade</p>
                                    <input type="number" placeholder="Nº" min='1' max={categoria.roupa.quantidade} />
                                </div>
                                <div id="btnLinkPrd" className="btnLinkPrd">
                                    <a href="/carrinhoDeCompra"><input type="button" value="Comprar" /></a>
                                    <a href={''}>Calcular frete</a>
                    ...
                    <GridVisuPrd id="gridVisuPrd" className="gridVisuPrd">
                        ...
                        <DescAnunPrd id="descAnunPrd" className="descAnunPrd">
                            <ConteudoDescAnunPrd id="conteudoDescAnunPrd" className="conteudoDescAnunPrd">
                                ...
                                <div id="tmnhQtd" className="tmnhQtd">
                                    <p>Quantidade</p>
                                    <input type="number" placeholder="Nº" min='1' max={categoria.suplemento.quantidade} />
                                </div>
                                <div id="btnLinkPrd" className="btnLinkPrd">
                                    <a href="/carrinhoDeCompra"><input type="button" value="Comprar" /></a>
                                    <a href={''}>Calcular frete</a>
